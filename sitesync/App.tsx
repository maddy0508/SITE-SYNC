...
const scannerContext: ProjectContextRecord = {
  personId: PERSON_ID, projectId: PROJECT_ID, organisationId: ORG_ID, companyId: COMPANY_ID,
  companyMembershipId: MEMBERSHIP_ID, projectRole: 'WORKER', selectedAt: '2026-09-11T00:00:00.000Z', updatedAt: '2026-09-11T00:00:00.000Z',
};

const rosterRecord: ProjectRosterRecord = {
  projectId: PROJECT_ID, personId: PERSON_ID, organisationId: ORG_ID, companyId: COMPANY_ID,
  displayName: 'ORG A WORKER', projectRole: 'WORKER', assignmentStatus: 'ACTIVE', membershipStatus: 'ACTIVE', syncedAt: '2026-09-11T00:00:00.000Z',
};
  ...
  return (
    <SafeAreaView style={styles.root}>
      ...
      <View style={styles.home}>
        ...
        <Pressable style={styles.primary} onPress={() => setScreen('m17qa')}><Text style={styles.primaryText}>RUN M1.7 REAL RUNTIME QA</Text></Pressable>
