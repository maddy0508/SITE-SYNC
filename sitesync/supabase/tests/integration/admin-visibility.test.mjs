...
const IDS = {
  ...
  workerBAttendanceEvent: '77777777-7777-4777-8777-777777777771',
  workerBAttendanceState: '77777777-7777-4777-8777-777777777772',
  workerBTimesheet: '77777777-7777-4777-8777-777777777773',
  projectA: '00000000-0000-4000-8000-000000000020',
  projectB: '00000000-0000-4000-8000-000000000120',
  projectC: '00000000-0000-4000-8000-000000000030',
...
test('Admin A cannot enumerate Worker B records outside Project A', async () => {
  ...
  const { data, error } = await client
    ...
    .eq('person_id', IDS.workerBPerson)
    .neq('project_id', IDS.projectA);
